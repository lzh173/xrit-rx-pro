...
argparser = argparse.ArgumentParser(description="将 xRIT 文件解密为明文 xRIT 文件（使用单层 DES）")
argparser.add_argument("KEYS", action="store", help="已解密的密钥文件")
argparser.add_argument("XRIT", action="store", help="要解密的 xRIT 文件（或文件夹）")
