...
argparser = argparse.ArgumentParser(description="从 LRIT 附加数据（ADD）文件中提取数据。")
argparser.add_argument("INPUT", action="store", help="要处理的 LRIT 文件（或文件夹）")
argparser.add_argument("-o", action="store_true", help="覆盖已存在的文件")
argparser.add_argument("--ext", action="store", help="LRIT 文件扩展名（默认 \".lrit\"）", default=".lrit")
...
def get_name(mode):
    ...
    names['SICEA'] = "海冰"
    names['SSTA'] = "海面温度分析"
    names['SSTF24'] = "海面温度预报（24小时）"
    names['SSTF48'] = "海面温度预报（48小时）"
    names['SSTF72'] = "海面温度预报（72小时）"
    names['SUFA03'] = "区域天气图"
    names['UP50A'] = "天气图"
    names['UP50F24'] = "天气预报（24小时）"
