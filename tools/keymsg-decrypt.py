...
argparser = argparse.ArgumentParser(description="解密 KMA 加密密钥消息文件，用于 GK-2A xRIT 解密。")
argparser.add_argument("PATH", action="store", help="加密密钥消息文件")
argparser.add_argument("MAC", action="store", help="地面站 MAC 地址")
